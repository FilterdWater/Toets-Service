...
export default function AvailableExamCard({ exam }: AvailableExamCardProps) {
    return (
        <Card
            ...
            className="flex max-w-72 min-w-72 cursor-pointer flex-col transition-all hover:shadow-lg hover:ring-1 hover:shadow-foreground/10 hover:ring-border dark:hover:shadow-foreground/10"
        >
